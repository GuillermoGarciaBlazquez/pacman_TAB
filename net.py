...
def save_model(model, input_size, model_path="models/pacman_model_5.pth"):
...
def main():
    ...
    maps1, actions1 = load_and_merge_data("pacman_wins")
    maps2, actions2 = load_and_merge_data("pacman_data_win/pacman_wins")
